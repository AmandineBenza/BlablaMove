...
#Create Offer
--
curl -H "Accept: application/json" -H "Content-type: application/json" -X POST -d "{"event":"create-offer","data":{"ownerID":"Machin@me.fr", "price":"0", "startCity":"startA", "endCity":"endA", "capacity":"3" }}" "localhost:8080/BBM/OFFERS"
--

 curl -H "Accept: application/json" -H "Content-type: application/json" -X POST -d "{"event":"create-offer","data":{"ownerID":"Machin@me.fr", "price":"0", "startCity":"startA", "endCity":"endA", "capacity":"3" }}" "localhost:8080/BBM/OFFERS" | sed -D "\[\\d*":"\\d\]"


grep -o -P '\[\d* : \d*\]' | grep -o -P '\[\d*' | grep -o -P '\d*'
...
--
curl -H "Accept: application/json" -H "Content-type: application/json" -X POST -d '{"event":"ask-offer" ,"data": {"offerID": "Machin@me.fr1541350614202_50","buyerID": "client@daniel.dog","weight": "5", "volume":"6", "date":"5" }}' "localhost:8080/BBM/OFFERS"
--
...
#curl -H "Accept: application/json" -H "Content-type: application/json" -X POST -d "{\"event\":\"confirm-command\" ,\"data\": {\"offerID\": \"$offerIdD\",\"date\":\"$inDays\",\"startAddress\": \"$startAddress\",\"endAddress\": \"$endAddress\",\"price\": \"10\" }}" "localhost:8080/BBM/OFFERS"
